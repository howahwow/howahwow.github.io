...
const TRANSLATIONS = {
  en: {
    ...
    /* ── Section headings ────────────────── */
    'belgrade.intro.p1': 'New Belgrade was built from nothing. On the marshland between the Sava and the Danube, on the empty ground dividing two older cities, socialist Yugoslavia raised an entirely new capital district from the 1950s onward: superblocks numbered rather than named, boulevards wide enough for parades, concrete towers standing in open green space. The scale was deliberate. This was meant to be the physical form of a new society.',
    'belgrade.intro.p2': 'Yugoslav modernism was never Soviet. After the 1948 split with Stalin and the turn toward the Non-Aligned Movement, architects here worked with a freedom their counterparts in the Eastern Bloc did not have — travelling, publishing, entering international competitions. What they produced at Genex Tower, the Eastern City Gates and the Sava Centre is more inventive and more sculptural than anything built in Moscow at the same time. Much of it is now protected. Much of it is also crumbling.',
    'berlin.intro.p1': 'No city wears the architecture of the Cold War as plainly as Berlin. For forty years two systems built in the same place, in full view of each other, each treating construction as an argument. East Berlin answered with Karl-Marx-Allee — Stalinist workers\' palaces faced in ceramic tile — and then, after 1960, with the glass and prefabricated concrete of Alexanderplatz. West Berlin answered with the Hansaviertel and the modernism of the Interbau exhibition.',
    'berlin.intro.p2': 'The Fernsehturm, completed in 1969 and still the tallest structure in Germany, was built to be visible from the other side. Around it stand the Haus des Lehrers with its wraparound frieze, the Haus des Reisens, and the Plattenbau housing that gave the DDR its everyday shape. Since reunification much has been demolished, renovated or quietly rebranded. What survives is the record of a state that no longer exists.',
    'london.intro.p1': 'British Brutalism came out of the welfare state. In the decades after 1945, London\'s public architecture — housing estates, universities, arts centres — was built at public expense for a public purpose, and the material was béton brut: concrete left rough and unfaced, still showing the grain of the timber it was cast against. The term New Brutalism was coined here, in the arguments between Alison and Peter Smithson and the critic Reyner Banham.',
    'london.intro.p2': 'The results divided opinion from the start and still do. The Barbican, the National Theatre, the Hayward Gallery, Ernő Goldfinger\'s Trellick Tower — each has been called both a masterpiece and an eyesore, each has been listed and threatened, gentrified and demolished. London\'s brutalist buildings are among the most photographed in the world, and among the most misunderstood.',
    'chisinau.intro.p1': 'Chișinău was rebuilt twice — after the earthquake of 1940 and again after the destruction of the Second World War — and what stands today is largely the work of Soviet architects planning the capital of the Moldavian SSR. Wide axial boulevards, government buildings in stripped classicism, and from the 1960s onward a more confident modernism: the State Circus, Hotel National, the Palace of the Republic.',
    'chisinau.intro.p2': 'What sets Chișinău apart is its monumental decorative art. Soviet mosaics survive here in unusual density — on bus stops, power stations, telecom buildings, the railway station — the work of artists given licence to be ornamental within a system that generally was not. Most carry no protected status. Many have already disappeared behind advertising hoardings or insulation cladding.',
    'bucharest.intro.p1': 'Bucharest is the clearest case in Europe of a city rewritten by political will. Under Nicolae Ceaușescu\'s programme of sistematizare — systematisation — roughly a fifth of the historic centre was demolished during the 1980s. Churches, hospitals and entire neighbourhoods were destroyed, or in a few cases physically moved on rails, to clear ground for the Civic Centre and the boulevard leading to it.',
    'bucharest.intro.p2': 'At the end of that boulevard stands the Palace of the Parliament: the heaviest building on earth, the largest administrative building after the Pentagon, and still unfinished when the regime fell in 1989. But Bucharest\'s socialist architecture is not only that. The modernism of the 1960s — Tehnoimport, the Politehnica metro station, the state circus — belongs to a briefer and more open period, before systematisation began.',
    'tiraspol.intro.p1': 'Transnistria — the Pridnestrovian Moldavian Republic — declared independence from Moldova in 1990 and fought a short war for it in 1992. No United Nations member state recognises it. For its architecture this has meant a kind of preservation by isolation: the Soviet urban landscape of Tiraspol and Bender was never subjected to the demolition, privatisation and rebranding that swept the rest of the former USSR after 1991.',
    'tiraspol.intro.p2': 'Lenin still stands in front of the Dom Sovetov. The hammer and sickle remains on the state emblem. Soviet-era housing blocks, the Palace of the Republic, the Green Market, the war memorial — all remain in use and largely in original form. Tiraspol is not a museum of the Soviet Union. It is a working city that simply never stopped being one.',
    'poland.intro.p1': 'Warsaw was destroyed more completely than any other European capital — by the Ghetto Uprising of 1943, the Warsaw Uprising of 1944, and the systematic demolition that followed. What replaced it was built under a socialist state: first the Palace of Culture and Science, Stalin\'s gift to the Polish people, and the socialist realism of the early 1950s; then, after the political thaw of 1956, a freer and more experimental modernism.',
    'poland.intro.p2': 'That later period produced most of the buildings documented here — the Warsaw Uprising Monument, Ochota station, the university faculties — and in Wrocław the residential towers known as Wrocławski Manhattan. Polish postwar architecture is unusually varied because the politics kept changing, and each shift left its own buildings behind.',
    'belgrade.h2.buildings': 'Brutalist & Socialist Buildings in Belgrade',
    'belgrade.h2.more': 'More Brutalist & Socialist Architecture in Belgrade',
    'belgrade.intro.p3': 'For anyone planning architecture tourism in Serbia, New Belgrade is walkable in a day: Blocks 22 and 23, the Sava Centre and the Genex Tower sit within a few tram stops of one another. Everything here was photographed on foot, in ordinary weather, without permits or drones.',
    'berlin.h2.buildings': 'DDR & Cold War Architecture in Berlin',
    'berlin.h2.more': 'More DDR & Cold War Architecture in Berlin',
    'berlin.intro.p3': 'Berlin is the most accessible city in Europe for both architecture tourism and dark tourism: the Wall memorial, Checkpoint Charlie, the Soviet War Memorial in Treptower Park and the DDR modernism of Alexanderplatz are all reachable on a single day\'s public transport ticket.',
    'london.h2.buildings': 'Brutalist Architecture in London',
    'london.h2.more': 'More Brutalist Architecture in London',
    'london.intro.p3': 'Brutalist architecture in London is unusually easy to visit — the Barbican, the South Bank and Trellick Tower are public or semi-public spaces that anyone can walk through, for free. This site documents them as they are actually used, not as show pieces.',
    'chisinau.h2.buildings': 'Soviet Architecture & Mosaics in Chișinău',
    'chisinau.h2.more': 'More Soviet Architecture & Mosaics in Chișinău',
    'chisinau.intro.p3': 'Soviet architecture in Moldova receives very few visitors, which is part of what makes architecture tourism here rewarding: the mosaics, the State Circus and the government buildings can be covered in two days on foot and by trolleybus, with almost nobody else photographing them.',
    'bucharest.h2.buildings': 'Communist & Socialist Architecture in Bucharest',
    'bucharest.h2.more': 'More Communist & Socialist Architecture in Bucharest',
    'bucharest.intro.p3': 'Communist architecture in Bucharest draws a steady stream of dark tourism to the Palace of the Parliament, but it is the surrounding Civic Centre — the blocks, the boulevard, the displaced churches — where the programme is easiest to read, and it is almost always empty.',
    'tiraspol.h2.buildings': 'Soviet Architecture in Transnistria',
    'tiraspol.h2.more': 'More Soviet Architecture in Transnistria',
    'tiraspol.intro.p3': 'Transnistria has become a fixture on dark tourism itineraries, and it is a strange place to be a tourist in: a functioning state that most of the world says does not exist. Everything photographed here was reached on a day trip from Chișinău, by marshrutka and on foot.',
    'poland.h2.buildings': 'Communist & Socialist Architecture in Poland',
    'poland.h2.more': 'More Communist & Socialist Architecture in Poland',
    'poland.intro.p3': 'Communist architecture in Warsaw and Wrocław is well signposted for architecture tourism, but the buildings worth the detour are rarely the famous ones — the university faculties, the suburban stations and the housing estates carry the period more honestly than the Palace of Culture.',
    ...
    'support.p3':       '<strong>Next destinations being planned:</strong> Lithuania, Latvia, Estonia. More Soviet modernism. More forgotten landmarks. More photographs.',
    'support.opt1.label': 'Buy Me a Coffee',
    'support.opt1.text':  'A one-time or recurring contribution via Buy Me a Coffee. No account needed — any amount helps.',
  ...
  zh: {
    ...
    /* ── Section headings ────────────────── */
    'belgrade.intro.p1': '新貝爾格勒是從無到有建起來的。在薩瓦河與多瑙河之間的沼澤地上、在兩座舊城之間的空地上，社會主義南斯拉夫從 1950 年代起造出一整個全新的首都區：街區以編號而非名稱標示、大道寬得足以舉行閱兵、混凝土高塔矗立在開闊綠地之中。這種尺度是刻意的——它要成為一個新社會的具體形狀。',
    'belgrade.intro.p2': '南斯拉夫的現代主義從來就不是蘇聯式的。1948 年與史達林決裂、轉向不結盟運動之後，這裡的建築師擁有東歐同行所沒有的自由：能出國、能發表、能參加國際競圖。他們在西部之門、東城門與薩瓦中心留下的作品，比同時期莫斯科的任何建築都更具實驗性與雕塑感。其中許多如今受到保護，也有許多正在崩壞。',
    'berlin.intro.p1': '沒有任何城市像柏林這樣，把冷戰的建築如此赤裸地穿在身上。四十年間，兩種制度在同一個地方、在彼此的注視下建造，各自把營建當成一場論證。東柏林的答案是卡爾馬克思大道——貼著陶瓷磚的史達林式「工人宮殿」——1960 年後則是亞歷山大廣場的玻璃與預鑄混凝土。西柏林的答案則是漢薩區與國際建築展的現代主義。',
    'berlin.intro.p2': '1969 年落成的電視塔至今仍是德國最高的建築物，當初就是要讓另一邊看得見。塔的周圍是帶有環繞浮雕的教師之家、旅行者之家，以及構成東德日常樣貌的板式住宅。兩德統一後，許多建築被拆除、翻修，或悄悄換了名字。留下來的，是一個已不存在的國家的紀錄。',
    'london.intro.p1': '英國粗野主義誕生於福利國家。1945 年後的數十年間，倫敦的公共建築——住宅區、大學、藝文中心——以公帑興建、為公眾服務，而它們的材料是 béton brut：不加修飾的粗糙混凝土，表面仍留著澆置時木模板的紋理。「新粗野主義」一詞正是在這裡、在史密森夫婦與評論家班漢姆的論戰中誕生的。',
    'london.intro.p2': '這些建築從一開始就引發兩極評價，至今依然。巴比肯中心、國家劇院、海沃美術館、戈德芬格的特雷利克塔——每一座都同時被稱為傑作與眼中釘，都曾被列為古蹟也曾面臨拆除，被仕紳化也被剷平。倫敦的粗野主義建築是世界上最常被拍攝的，也是最常被誤解的。',
    'chisinau.intro.p1': '基希訥烏被重建過兩次——1940 年大地震之後，以及二戰的破壞之後——今天所見的城市樣貌，大多出自規劃摩爾多瓦蘇維埃社會主義共和國首都的蘇聯建築師之手。寬闊的軸線大道、簡化古典主義的政府建築，以及 1960 年代之後更為自信的現代主義：國家馬戲團、國家飯店、共和國宮。',
    'chisinau.intro.p2': '基希訥烏真正與眾不同的，是它的紀念性裝飾藝術。蘇聯馬賽克在這裡以罕見的密度倖存下來——公車站、發電廠、電信大樓、火車站——這些是藝術家在一個普遍不容裝飾的體制中，被特許發揮的成果。它們大多沒有任何保護身分，也已有許多消失在廣告看板或外牆保溫層之後。',
    'bucharest.intro.p1': '布加勒斯特是歐洲最清楚的一個案例：一座被政治意志改寫的城市。在西奧塞古的「系統化」計畫下，1980 年代約有五分之一的歷史城區遭到拆除。教堂、醫院與整片街區被摧毀，少數則被架上軌道整棟搬遷，只為了替人民宮與通往它的大道騰出空間。',
    'bucharest.intro.p2': '那條大道的盡頭矗立著人民宮：地球上最重的建築、僅次於五角大廈的最大行政建築，而 1989 年政權垮台時它仍未完工。但布加勒斯特的社會主義建築不只如此。1960 年代的現代主義——Tehnoimport、理工大學地鐵站、國家馬戲團——屬於系統化開始之前，一段更短暫也更開放的時期。',
    'tiraspol.intro.p1': '德涅斯特河沿岸共和國於 1990 年宣布脫離摩爾多瓦獨立，並在 1992 年為此打了一場短暫的戰爭。沒有任何聯合國會員國承認它。對建築而言，這意味著一種因孤立而生的保存：蒂拉斯波爾與本德爾的蘇聯城市景觀，從未經歷 1991 年後席捲前蘇聯各地的拆除、私有化與品牌重塑。',
    'tiraspol.intro.p2': '列寧依然站在蘇維埃宮前。鎚子與鐮刀仍留在國徽上。蘇聯時期的住宅樓、共和國宮、綠色市場、戰爭紀念碑——全都仍在使用，且大致維持原貌。蒂拉斯波爾不是一座蘇聯博物館，它是一座運作中的城市，只是從來沒有停下來過。',
    'poland.intro.p1': '華沙的毀滅程度超過任何一座歐洲首都——1943 年的猶太區起義、1944 年的華沙起義，以及其後有計畫的徹底拆毀。取而代之的城市是在社會主義體制下建成的：先是史達林送給波蘭人民的「禮物」文化科學宮，以及 1950 年代初期的社會主義寫實主義；1956 年政治解凍之後，則轉向更自由、更具實驗性的現代主義。',
    'poland.intro.p2': '本站記錄的建築多半出自後面這個時期——華沙起義紀念碑、Ochota 車站、幾座大學院系建築——以及弗次瓦夫那組被稱為「弗次瓦夫曼哈頓」的住宅高樓。波蘭戰後建築之所以格外多樣，是因為政治不斷改變，而每一次轉向都留下了自己的建築。',
    'belgrade.h2.buildings': '貝爾格勒的粗野主義與社會主義建築',
    'belgrade.h2.more': '更多貝爾格勒的粗野主義與社會主義建築',
    'belgrade.intro.p3': '如果你打算到塞爾維亞進行建築旅行，新貝爾格勒一天就能走完：22、23 號街區、薩瓦中心與西部之門彼此之間只隔幾站電車。這裡的照片全是徒步拍攝，在再平常不過的天氣裡，沒有申請許可，也沒有空拍機。',
    'berlin.h2.buildings': '柏林的東德與冷戰建築',
    'berlin.h2.more': '更多柏林的東德與冷戰建築',
    'berlin.intro.p3': '柏林是全歐洲最適合建築旅行與黑暗旅遊（dark tourism）的城市：圍牆紀念園區、查理檢查哨、特雷普托公園的蘇聯戰爭紀念碑，以及亞歷山大廣場的東德現代主義，用一張一日票就能全部走完。',
    'london.h2.buildings': '倫敦的粗野主義建築',
    'london.h2.more': '更多倫敦的粗野主義建築',
    'london.intro.p3': '倫敦的粗野主義建築特別容易造訪——巴比肯、南岸中心與特雷利克塔都是公共或半公共空間，任何人都能自由走進去。本站記錄的是它們被實際使用的樣子，而不是展示品。',
    'chisinau.h2.buildings': '基希訥烏的蘇聯建築與馬賽克',
    'chisinau.h2.more': '更多基希訥烏的蘇聯建築與馬賽克',
    'chisinau.intro.p3': '摩爾多瓦的蘇聯建築幾乎沒什麼觀光客，而這正是在這裡進行建築旅行的迷人之處：馬賽克、國家馬戲團與政府建築，靠徒步和無軌電車兩天就能走完，而且幾乎沒有別人在拍。',
    'bucharest.h2.buildings': '布加勒斯特的共產與社會主義建築',
    'bucharest.h2.more': '更多布加勒斯特的共產與社會主義建築',
    'bucharest.intro.p3': '布加勒斯特的共產主義建築為人民宮帶來源源不絕的黑暗旅遊人潮，但真正能讀懂這套計畫的地方，其實是周圍的公民中心——那些街區、那條大道、那些被迫遷移的教堂——而那裡幾乎總是空無一人。',
    'tiraspol.h2.buildings': '德涅斯特河沿岸的蘇聯建築',
    'tiraspol.h2.more': '更多德涅斯特河沿岸的蘇聯建築',
    'tiraspol.intro.p3': '德涅斯特河沿岸已經是黑暗旅遊行程上的固定景點，而在這裡當一個遊客的感覺很奇特：一個運作中的國家，世界上大多數人卻說它不存在。這裡的照片全是從基希訥烏當天來回，搭小巴加徒步拍下的。',
    'poland.h2.buildings': '波蘭的共產與社會主義建築',
    'poland.h2.more': '更多波蘭的共產與社會主義建築',
    'poland.intro.p3': '華沙與弗次瓦夫的共產主義建築在建築旅行地圖上標示得很清楚，但真正值得繞路去看的往往不是名景——那些大學院系建築、通勤車站與住宅區，比文化科學宮更誠實地承載了那個年代。',
    'section.gallery':   '相簿',
    'section.video':     '影片',
    'section.cities':    '城市',
    ...
    'support.p3':       '<strong>下一批正在規劃的目的地：</strong>立陶宛、拉脫維亞、愛沙尼亞。更多蘇聯現代主義。更多被遺忘的地標。更多照片。',
    'support.opt1.label': 'Buy Me a Coffee',
    'support.opt1.text':  '透過 Buy Me a Coffee 進行一次性或定期贊助，無需帳戶，任何金額都有幫助。',
